from requests import get as g, exceptions
...
class Client:
    def __init__(self):
        try:
            ...
            print(f'Unable to get offsets due to a network error: {e}')
            exit()
        except ValueError as e:
            print(f'Unable to get offsets due to a JSON decoding error: {e}')
            exit()
    def offset(self, a):
        try:
